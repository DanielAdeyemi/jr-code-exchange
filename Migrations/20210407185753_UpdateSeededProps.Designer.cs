...
namespace CodeExchange.Migrations
{
    ...
    [Migration("20210407185753_UpdateSeededProps")]
    partial class UpdateSeededProps
    {
            ...
            modelBuilder.Entity("CodeExchange.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDate = new DateTime(2021, 4, 7, 16, 57, 52, 228, DateTimeKind.Local).AddTicks(226),
                            CreatorId = 1,
                            Dislikes = 0,
                            IsVisible = true,
                            Likes = 2,
                        ...
                        new
                        {
                            ...
                            CreationDate = new DateTime(2021, 4, 7, 11, 57, 52, 228, DateTimeKind.Local).AddTicks(730),
                            CreatorId = 2,
                            Dislikes = 0,
                            IsVisible = true,
                            Likes = 100,
                        ...
                        new
                        {
                            ...
                            CreationDate = new DateTime(2021, 4, 7, 11, 57, 52, 228, DateTimeKind.Local).AddTicks(738),
                            CreatorId = 3,
                            Dislikes = 0,
                            IsVisible = true,
                            Likes = 3,
                        ...
                        new
                        {
                            ...
                            CreationDate = new DateTime(2021, 4, 7, 11, 57, 52, 228, DateTimeKind.Local).AddTicks(745),
                            CreatorId = 4,
                            Dislikes = 0,
                            IsVisible = true,
                            Likes = 9,
                        ...
                        new
                        {
                            ...
                            CreationDate = new DateTime(2021, 4, 7, 11, 57, 52, 228, DateTimeKind.Local).AddTicks(752),
                            CreatorId = 1,
                            Dislikes = 10,
                            IsVisible = true,
                            Likes = 0,
