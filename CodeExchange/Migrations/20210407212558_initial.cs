    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Posts",
                columns: new[] { "PostId", "AppUserId", "AppUserId1", "Content", "CreationDate", "CreatorId", "Dislikes", "IsVisible", "Likes", "PostId1", "Title" },
                values: new object[,]
                {
                    { 1, null, null, "Python dookie", new DateTime(2021, 4, 7, 19, 25, 57, 490, DateTimeKind.Local).AddTicks(8690), 1, 0, true, 2, null, "Python Sucks" },
                    { 2, null, null, "Swift dookie", new DateTime(2021, 4, 7, 14, 25, 57, 490, DateTimeKind.Local).AddTicks(9430), 2, 0, true, 100, null, "Swift Sucks" },
                    { 3, null, null, "C# dookie", new DateTime(2021, 4, 7, 14, 25, 57, 490, DateTimeKind.Local).AddTicks(9440), 3, 0, true, 3, null, "C# Sucks" },
                    { 4, null, null, "Java dookie", new DateTime(2021, 4, 7, 14, 25, 57, 490, DateTimeKind.Local).AddTicks(9440), 4, 0, true, 9, null, "Java Sucks" },
                    { 5, null, null, "JavaScript dookie", new DateTime(2021, 4, 7, 14, 25, 57, 490, DateTimeKind.Local).AddTicks(9450), 1, 10, true, 0, null, "JavaScript Sucks" }
                });
