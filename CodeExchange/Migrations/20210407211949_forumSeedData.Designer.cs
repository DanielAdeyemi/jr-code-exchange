...
namespace CodeExchange.Migrations
{
    ...
    [Migration("20210407211949_forumSeedData")]
            ...
            modelBuilder.Entity("CodeExchange.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDate = new DateTime(2021, 4, 7, 19, 19, 49, 153, DateTimeKind.Local).AddTicks(1584),
                            CreatorId = 1,
                            Dislikes = 0,
                            IsVisible = true,
                            Likes = 2,
                        ...
                        new
                        {
                            ...
                            CreationDate = new DateTime(2021, 4, 7, 14, 19, 49, 153, DateTimeKind.Local).AddTicks(1926),
                            CreatorId = 2,
                            Dislikes = 0,
                            IsVisible = true,
                            Likes = 100,
                        ...
                        new
                        {
                            ...
                            CreationDate = new DateTime(2021, 4, 7, 14, 19, 49, 153, DateTimeKind.Local).AddTicks(1932),
                            CreatorId = 3,
                            Dislikes = 0,
                            IsVisible = true,
                            Likes = 3,
                        ...
                        new
                        {
                            ...
                            CreationDate = new DateTime(2021, 4, 7, 14, 19, 49, 153, DateTimeKind.Local).AddTicks(1937),
                            CreatorId = 4,
                            Dislikes = 0,
                            IsVisible = true,
                            Likes = 9,
                        ...
                        new
                        {
                            ...
                            CreationDate = new DateTime(2021, 4, 7, 14, 19, 49, 153, DateTimeKind.Local).AddTicks(1943),
                            CreatorId = 1,
                            Dislikes = 10,
                            IsVisible = true,
                            Likes = 0,
